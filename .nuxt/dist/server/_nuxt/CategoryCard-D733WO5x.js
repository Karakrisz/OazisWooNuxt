import { f as useHelpers, g as __nuxt_component_10, h as __nuxt_component_3, c as _export_sfc } from "../server.mjs";
        ...
        _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              ...
              _push2(`<div class="absolute inset-x-0 bottom-0 opacity-50 bg-gradient-to-t from-black to-transparent h-1/2" data-v-9fe96486${_scopeId}></div><span class="relative z-10 mt-auto mb-2 text-sm font-semibold text-white capitalize md:text-base md:mb-4" data-v-9fe96486${_scopeId}>${__props.node.name ?? ""}</span>`);
            } else {
              return [
...
//# sourceMappingURL=CategoryCard-D733WO5x.js.map
