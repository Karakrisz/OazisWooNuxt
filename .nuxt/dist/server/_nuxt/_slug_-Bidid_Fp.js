import { defineComponent, withCtx, unref, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext, computed, mergeProps, ref, watch, withAsyncContext, useModel } from "vue";
import { d as useHead, f as useHelpers, q as useRoute, s as useImage, n as useRuntimeConfig, g as __nuxt_component_10, h as __nuxt_component_3, c as _export_sfc, S as StockStatusEnum, u as useCart, p as useI18n, b as _sfc_main$e, _ as __nuxt_component_0$2, o as useAppConfig, e as useAsyncGql, P as ProductTypesEnum } from "../server.mjs";
...
import { a as __nuxt_component_0$1, b as _sfc_main$f } from "./ProductCard-CyaaayoS.js";
import { _ as _sfc_main$g } from "./ProductPrice-DSq3K8MZ.js";
import { u as useWishlist } from "./useWishlist-BIY00RKh.js";
import "hookable";
import "destr";
import "klona";
import "defu";
import { _ as _sfc_main$h } from "./ProductRow-CIKX0R-V.js";
import "ofetch";
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const imageURL = ((_a = info.image) == null ? void 0 : _a.sourceUrl) ?? "/images/placeholder.jpg";
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    (gqlEndpoint == null ? void 0 : gqlEndpoint.replace("/graphql", "")) ?? null;
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_LoadingIcon = _sfc_main$e;
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_StarRating = _sfc_main$f;
      const _component_Icon = __nuxt_component_0$2;
      const _component_LoadingIcon = _sfc_main$e;
      ...
      if (unref(show)) {
        ...
        if (unref(errorMessage)) {
          _push(`<div class="my-4 text-sm text-red-500" data-v-ba6de38c>${unref(errorMessage) ?? ""}</div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(successMessage)) {
          _push(`<div class="my-4 text-sm text-green-500" data-v-ba6de38c>${unref(successMessage) ?? ""}</div>`);
        } else {
          _push(`<!---->`);
        }
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    if (fuggony == 1 && extra_product_field == 1) {
      if ((type == null ? void 0 : type.value.rawSalePrice) > 0) type.value.salePrice = parseInt(type == null ? void 0 : type.value.rawSalePrice) + parseInt((_k = (_j = product.value.metaData) == null ? void 0 : _j.filter((p) => (p == null ? void 0 : p.key) == "varras")[0]) == null ? void 0 : _k.value) + "";
    ...
    const selectProductInput = computed(() => {
      ...
      return {
        ...
        variationId: ((_b2 = activeVariation.value) == null ? void 0 : _b2.databaseId) ?? null,
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_StarRating = _sfc_main$f;
      const _component_ProductPrice = _sfc_main$g;
      ...
      const _component_ProductRow = _sfc_main$h;
      if (unref(product)) {
        ...
        if (unref(fuggony)) {
          _push(`<span data-v-f2a11f0b> szélesség: ${ssrInterpolate(unref(widthInput))}cm,</span>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(fuggony)) {
          _push(`<span data-v-f2a11f0b> magasság: ${ssrInterpolate(unref(heightInput))}cm</span>`);
        } else {
          _push(`<!---->`);
        }
        ...
        if (unref(fuggony)) {
          ...
          if (unref(fuggony)) {
            _push(`<div class="flex items-center gap-2" data-v-f2a11f0b><input type="radio" id="ftype1" name="ftype"${ssrIncludeBooleanAttr(ssrLooseEqual(extra_product_field.value, 1)) ? " checked" : ""}${ssrRenderAttr("value", 1)} data-v-f2a11f0b><label for="ftype1" data-v-f2a11f0b> Készre varrás</label><input type="radio" id="ftype2" name="ftype"${ssrIncludeBooleanAttr(ssrLooseEqual(extra_product_field.value, 0)) ? " checked" : ""}${ssrRenderAttr("value", 0)} data-v-f2a11f0b><label for="ftype2" data-v-f2a11f0b> Méteráru</label></div>`);
          } else {
            _push(`<!---->`);
          }
          if (unref(fuggony)) {
            ...
            if (extra_product_field.value === 1) {
              _push(`<h3 data-v-f2a11f0b>Varrás: ${ssrInterpolate(unref(varras) / 100)} Ft/cm</h3>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
          ...
          if (unref(fuggony)) {
            _push(`<div class="flex items-center gap-2" data-v-f2a11f0b><h3 data-v-f2a11f0b>Szélesség (cm): <input type="number" name="fwidth"${ssrRenderAttr("value", unref(widthInput))} data-v-f2a11f0b></h3><h3 data-v-f2a11f0b>Magasság (cm): <input type="number" name="fheight"${ssrRenderAttr("value", unref(heightInput))} data-v-f2a11f0b></h3></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        _push(`</div><div class="mb-8 font-light prose" data-v-f2a11f0b>${(unref(product).shortDescription || unref(product).description) ?? ""}</div><hr data-v-f2a11f0b><form data-v-f2a11f0b><input type="hidden" id="extra_product_field"${ssrRenderAttr("value", extra_product_field.value)} data-v-f2a11f0b>`);
...
//# sourceMappingURL=_slug_-Bidid_Fp.js.map
