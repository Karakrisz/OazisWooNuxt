import { c as _export_sfc, j as useAuth, p as useI18n, k as useRouter, f as useHelpers, u as useCart, q as useRoute, r as useSeoMeta, b as _sfc_main$c, _ as __nuxt_component_0$1, g as __nuxt_component_10 } from './server.mjs';
import { useSSRContext, defineAsyncComponent, defineComponent, ref, unref, mergeProps, computed, withCtx, createVNode, createTextVNode, toDisplayString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderList } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue/server-renderer/index.mjs';
import { a as __nuxt_component_1, _ as _sfc_main$1$1 } from './CountrySelect-oCBY2zra.mjs';
import { _ as _sfc_main$7 } from './PasswordInput-C2vEixSX.mjs';
import { _ as __nuxt_component_3, a as __nuxt_component_5$1 } from './DownloadableItems-DFdX3e52.mjs';
import { _ as _sfc_main$8 } from './WishList-CrRgkyZD.mjs';
...
const __nuxt_component_0_lazy = defineAsyncComponent(() => import('./CountrySelect-oCBY2zra.mjs').then(function(n) {
  return n.S;
}).then((c) => c.default || c));
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_PasswordInput = _sfc_main$7;
      const _component_LoadingIcon = _sfc_main$c;
      ...
      if (unref(errorMessage)) {
        _push(`<div class="w-full text-sm text-red-500">${(_a = unref(errorMessage)) != null ? _a : ""}</div>`);
      } else {
        _push(`<!---->`);
      }
...
const __nuxt_component_1_lazy = defineAsyncComponent(() => import('./LoginAndRegister-5Xcughuv.mjs').then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_WishList = _sfc_main$8;
...
//# sourceMappingURL=index-DAAvChCs.mjs.map
