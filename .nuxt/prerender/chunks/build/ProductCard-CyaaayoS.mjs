import { c as _export_sfc, p as useI18n, o as useAppConfig, _ as __nuxt_component_0$1, q as useRoute, g as __nuxt_component_10, h as __nuxt_component_3$2 } from './server.mjs';
import { useSSRContext, defineComponent, mergeProps, computed, unref, ref, watch, withCtx, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrInterpolate } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue/server-renderer/index.mjs';
import { _ as _sfc_main$3 } from './ProductPrice-DSq3K8MZ.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const salePercentage = computed(() => {
      if (!(node == null ? void 0 : node.rawSalePrice) || !(node == null ? void 0 : node.rawRegularPrice))
        return "";
    ...
    const textToDisplay = computed(() => {
      if ((storeSettings == null ? void 0 : storeSettings.saleBadge) === "percent")
    ...
    const imagetoDisplay = computed(() => {
      ...
      if (paColor.value.length) {
        ...
        if (activeColorImage == null ? void 0 : activeColorImage.length)
          return ((_c2 = activeColorImage[0].image) == null ? void 0 : _c2.producCardSourceUrl) || ((_d2 = activeColorImage[0].image) == null ? void 0 : _d2.sourceUrl) || mainImage.value;
      }
...
//# sourceMappingURL=ProductCard-CyaaayoS.mjs.map
