...
import { ref, mergeProps, withCtx, createTextVNode, useSSRContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderComponent } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue/server-renderer/index.mjs';
import { useRoute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue-router/dist/vue-router.node.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (loading.value) {
        ...
        _push(`<div><h2 class="supage-content__h2 f-300">${ssrInterpolate(post.value.title)}</h2><img class="supage-content__img"${ssrRenderAttr("src", `https://fuggonyoazis.hu/api/public/storage/${post.value.image}`)}${ssrRenderAttr("alt", post.value.title)}><p class="supage-content__p">${(_a = post.value.body) != null ? _a : ""}</p></div>`);
      } else {
...
//# sourceMappingURL=_id_-cjovR7mK.mjs.map
