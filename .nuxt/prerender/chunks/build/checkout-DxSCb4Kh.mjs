import { p as useI18n, q as useRoute, u as useCart, j as useAuth, r as useSeoMeta, i as useState, m as GqlGetStates, f as useHelpers, n as useRuntimeConfig, b as _sfc_main$c, _ as __nuxt_component_0$1, g as __nuxt_component_10, G as GqlUpdateCustomer, k as useRouter, l as GqlCheckout, c as _export_sfc, o as useAppConfig, h as __nuxt_component_3$2 } from './server.mjs';
import { _ as _sfc_main$b } from './PasswordInput-C2vEixSX.mjs';
import { _ as _sfc_main$1$1, a as __nuxt_component_1 } from './CountrySelect-oCBY2zra.mjs';
import { useSSRContext, defineComponent, ref, computed, withAsyncContext, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, toRef, watch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderList, ssrRenderSlot, ssrRenderStyle } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/vue/server-renderer/index.mjs';
import { _ as __nuxt_component_0 } from './TrashIcon-DgRm1Dn1.mjs';
import { useSwipe } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/@vueuse/core/index.mjs';
import { _ as _sfc_main$d } from './ProductPrice-DSq3K8MZ.mjs';
import { u as useWishlist } from './useWishlist-BIY00RKh.mjs';
import { loadStripe } from 'file:///Applications/XAMPP/xamppfiles/htdocs/woonuxt-oazis/node_modules/@stripe/stripe-js/lib/index.js';
  ...
  const proccessCheckout = async (isPaid = false) => {
    ...
    try {
      ...
      if (await (checkout == null ? void 0 : checkout.redirect) && isPayPal) {
        ...
        let redirectUrl = (_a2 = checkout == null ? void 0 : checkout.redirect) != null ? _a2 : "";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(__props.options, (option) => {
        var _a2;
        _push(`<div class="${ssrRenderClass([{ "active-option": option.id === __props.activeOption }, "flex items-center justify-between option"])}" data-v-9043ed77><div data-v-9043ed77><div class="text-sm leading-tight text-gray-500" data-v-9043ed77>${(_a2 = option.label) != null ? _a2 : ""}</div><div class="font-semibold text-gray-600" data-v-9043ed77>${ssrInterpolate(unref(currencySymbol))}${ssrInterpolate(option.cost)}</div></div>`);
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList((_a = _ctx.paymentGateways) == null ? void 0 : _a.nodes, (gateway) => {
        ...
        _push(`<span class="whitespace-nowrap" data-v-e7723a37>${(_a3 = gateway.title) != null ? _a3 : ""}</span>`);
        _push(ssrRenderComponent(_component_icon, {
          name: "ion:checkmark-circle",
          size: "20",
          class: "ml-auto text-primary checkmark opacity-0"
      ...
      if (unref(activePaymentMethod).description) {
        _push(`<div class="prose block w-full" data-v-e7723a37><p class="text-sm text-gray-500" data-v-e7723a37>${(_a2 = unref(activePaymentMethod).description) != null ? _a2 : ""}</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(errorMessage)) {
        _push(`<div class="mt-2 text-xs text-red-600">${(_a = unref(errorMessage)) != null ? _a : ""}</div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(cart) && unref(cart).appliedCoupons) {
        ...
        ssrRenderList(unref(cart).appliedCoupons, (coupon, index) => {
          ...
          if (coupon == null ? void 0 : coupon.code) {
            _push(`<div class="bg-primary border-primary border rounded-md flex bg-opacity-5 border-opacity-10 text-primary leading-none p-1.5 gap-1 items-center"><span>${(_a2 = coupon.code) != null ? _a2 : ""}</span>`);
            _push(ssrRenderComponent(_component_Icon, {
              name: "ion:close",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(cart)) {
        ...
        _push(`<div class="grid gap-1 text-sm font-semibold text-gray-500"><div class="flex justify-between"><span>${ssrInterpolate(_ctx.$t("messages.shop.subtotal"))}</span><span class="text-gray-700 tabular-nums">${(_a = unref(cart).subtotal) != null ? _a : ""}</span></div><div class="flex justify-between"><span>${ssrInterpolate(_ctx.$t("messages.general.shipping"))}</span><span class="text-gray-700 tabular-nums">${ssrInterpolate(parseFloat(unref(cart).shippingTotal) > 0 ? "+" : "")} ${ssrInterpolate(unref(cart).shippingTotal)}</span></div>`);
        if (unref(cart) && unref(cart).appliedCoupons) {
          _push(`<div class="flex justify-between"><span>${ssrInterpolate(_ctx.$t("messages.shop.discount"))}</span><span class="text-primary tabular-nums">- <span>${(_b = unref(cart).discountTotal) != null ? _b : ""}</span></span></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="flex justify-between mt-4"><span>${ssrInterpolate(_ctx.$t("messages.shop.total"))}</span><span class="text-lg font-bold text-gray-700 tabular-nums">${(_c = unref(cart).total) != null ? _c : ""}</span></div></div>`);
        ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
...
//# sourceMappingURL=checkout-DxSCb4Kh.mjs.map
