...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/devalue/index.js';
import destr from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/destr/dist/index.mjs';
import { renderToString } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/vue/index.mjs';
import { GraphQLClient } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/graphql-request/build/esm/index.js';
import { basename, isAbsolute } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/.nuxt/nuxt-icon-server-bundle.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/ipx/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/node_modules/@unhead/shared/dist/index.mjs';
...
const appConfig0 = defineAppConfig({
  siteName: "F\xFCgg\xF6ny O\xE1zis",
...
const _inlineRuntimeConfig = {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/woonuxt_base/public"
      ]
    },
    "http": {
      "domains": [
...
const serverAssets = [{"baseName":"server","dir":"/Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _T3sonfCpLd = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt";
...
const config = {"default":{"token":{"type":"Bearer","name":"Authorization"},"proxyCookies":true,"tokenStorage":{"mode":"cookie","cookieOptions":{"maxAge":604800,"secure":false},"name":"gql:default"},"preferGETQueries":false,"host":"https://fuggonyoazis.hu/restapi/graphql","corsOptions":{"mode":"cors","credentials":"include"}}};
const clients = {};
const GqlNitro = { clients, config };

const _TS8JahZOoU = defineNitroPlugin(() => {
...
const _YH1PON = defineCachedEventHandler(async (ctx) => {
...
const _hocKsn = lazyEventHandler(() => {
...
const _lazy_7l83sb = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_7l83sb, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _YH1PON, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _hocKsn, lazy: false, middleware: false, method: undefined },
  { route: '/products/**', handler: _lazy_7l83sb, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_7l83sb, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Applications/XAMPP/xamppfiles/htdocs/OazisWooNuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
